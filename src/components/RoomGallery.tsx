      ...
      <div className="grid grid-cols-4 grid-rows-2 gap-2 h-[420px] md:h-[500px] rounded-xl overflow-hidden">
        ...
        {[1, 2, 3, 4].map((i) => (
          <div
            ...
            onClick={() => {
              setActiveIndex(i < displayImages.length ? i : 0);
          ...
          >
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2">
              {displayImages.map((_, i) => (
                <button
                  key={i}
                  className={`w-2 h-2 rounded-full transition-all ${i === activeIndex ? "bg-accent w-6" : "bg-primary-foreground/40"}`}
