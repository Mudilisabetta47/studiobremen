...
export const InviteEmail = ({ siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Sie wurden zu BOLM Apartments eingeladen</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>Sie sind eingeladen</Heading>
          <Text style={text}>
            Sie wurden eingeladen, sich{' '}
            <Link href={siteUrl} style={link}><strong>BOLM Apartments</strong></Link>{' '}
            anzuschließen. Klicken Sie auf den Button unten, um die Einladung
        ...
        <Section style={brandFooter}>
          <Text style={brandFooterText}>
            BOLM Apartments · Bremen · <Link href={siteUrl} style={brandFooterLink}>bolm-apartments.de</Link>
          </Text>
        </Section>
      </Container>
    </Body>
